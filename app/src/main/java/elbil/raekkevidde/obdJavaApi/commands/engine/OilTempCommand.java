 ...
 * the License.
 */
package elbil.raekkevidde.obdJavaApi.commands.engine;
import elbil.raekkevidde.obdJavaApi.commands.temperature.TemperatureCommand;
...
public class OilTempCommand extends TemperatureCommand {
     ...
     * Copy ctor.
     *
     * @param other a {@link elbil.raekkevidde.obdJavaApi.commands.engine.OilTempCommand} object.
     */

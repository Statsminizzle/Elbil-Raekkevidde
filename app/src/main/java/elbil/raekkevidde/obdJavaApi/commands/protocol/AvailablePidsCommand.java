 ...
 * the License.
 */
package elbil.raekkevidde.obdJavaApi.commands.protocol;
import elbil.raekkevidde.obdJavaApi.commands.PersistentCommand;
...
public abstract class AvailablePidsCommand extends PersistentCommand {
     ...
     * Copy ctor.
     *
     * @param other a {@link elbil.raekkevidde.obdJavaApi.commands.protocol.AvailablePidsCommand} object.
     */
